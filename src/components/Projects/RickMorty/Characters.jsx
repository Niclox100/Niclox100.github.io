...
import "../../../assets/styles/components/projects/RickMorty/Characters.css"
...
/*     const filteredUsers = characters.filter((user) => {
    ...
    return (
        <div className="main">
            <div className="title">Tus personajes Favoritos</div>
           ...
           <Search search={search} searchInput={searchInput} handleSearch={handleSearch} />
            ...
            <div className="title">Lista de personajes</div>  
            <div className="main-container">
